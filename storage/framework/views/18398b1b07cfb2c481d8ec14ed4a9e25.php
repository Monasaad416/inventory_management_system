...
<?php $__env->startSection('page-header'); ?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تعديل فاتورة رقم <?php echo e($invoice->client_invoice_number); ?></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ فواتير العملاء </span>
            </div>
        </div>
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo e(route('clients-invoices.update' ,$invoice)); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col my-2">
                            ...
                            <input class="form-control fc-datepicker" name="invoice_date" placeholder="YYYY-MM-DD" type="text" value="<?php echo e(old('client_invoice_date', $invoice->client_invoice_date)); ?>">
                        </div>
                        ...
                        <div class="col my-2">
                            ...
                            <select name="client_id" class="form-control">
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if( $client->id == $invoice->user->id ): ?>
                                        ...
                                        <?php $__currentLoopData = $invoice->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="name" class="form-control"  readonly value="<?php echo e($prod->product_name); ?>">
                                                    </td>

                                                    <td>
                                                        <input type="number" step="any" class="form-control qty" data-quantity="<?php echo e($pivotRow->qty); ?>"  name="qty[]" min="0" step="any" value="<?php echo e($pivotRow->qty); ?>">
                                                    </td>

                                                    <td><input type="number" step="any" value="<?php echo e($pivotRow->product_price); ?>" name="sale_price[]" class="form-control price"></td>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        ...
                        <textarea class="form-control" id="exampleTextarea" name="note" rows="3"><?php echo e($invoice->note); ?></textarea>
                        </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/clients-invoices/edit.blade.php ENDPATH**/ ?>