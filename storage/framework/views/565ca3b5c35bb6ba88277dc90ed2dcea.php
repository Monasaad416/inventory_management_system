        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class=" d-inline-flex justify-content-around mt-5">
                    <div><button class="btn btn-primary"><a class="custom_link text-white" href="<?php echo e(route('clients-invoices.create')); ?>">إضافة فاتورة</a></button></div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $clientsInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"  href="<?php echo e(route('clients-invoices.edit',$invoice)); ?>">
                                                    <i class="fa fa-edit text-info mx-1"></i>تعديل الفاتورة
                                                    </a>

                                                <a class="dropdown-item"  href="<?php echo e(route('clients-invoices.show',$invoice)); ?>">
                                                    ...
                                                    data-target="#delete<?php echo e($invoice->id); ?>" title="Delete Invoice">
                                                        <i class="fa fa-trash text-danger mx-1"></i> تحويل إلي مرتجع
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('print-client-invoice',['invoice_id'=>$invoice->id])); ?>"><i class="fa fa-print mx-1" aria-hidden="true"></i>طباعة الفاتورة</a>
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="<?php echo e(route('clients-invoice.return',$invoice->id)); ?>">
                                                                                                    <?php echo csrf_field(); ?>
                                                                                                     
                                                                                                    <p class="text-danger font-weight-bold my-3">هل انت متأكد من حذف الفاتورة رقم  <?php echo e($invoice->client_invoice_number); ?></p>
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="<?php echo e(route('clients-invoice.partially-paid',$invoice->id)); ?>">
                                                                                                    <?php echo csrf_field(); ?>
                                                                                                     
                                                                                                    <p class=" font-weight-bold my-3">ادخل المبلغ الذي تم سداده   من الفاتورة رقم  <?php echo e($invoice->client_invoice_number); ?></p>
                                                                                                    <input class="form-control" name="invoice_id" value="<?php echo e($invoice->id); ?>" type="hidden">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/clients-invoices/index.blade.php ENDPATH**/ ?>