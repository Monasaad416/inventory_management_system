...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col my-3">
                                        ...
                                        <input type="number" name="store_amount" min="0" class="form-control" value="<?php echo e(old('store_amount')); ?>" step="any">
                                    </div>
                                ...
                                <select name="section_id" class="form-control ">
                                    <option value="0"> --إختار القسم--</option>
                                     <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($section->id); ?>" <?php echo e(old('section_id') == $section->id ? 'selected' : ''); ?>> <?php echo e($section->section_name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col my-2">
                                    ...
                                    <input class="form-control" name="purchase_price" type="number" step="any" value="<?php echo e(old('purchase_price')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col my-2">
                                    ...
                                    <input class="form-control" name="sale_price" type="number" step="any" value="<?php echo e(old('sale_price')); ?>">
                                </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/products/create.blade.php ENDPATH**/ ?>