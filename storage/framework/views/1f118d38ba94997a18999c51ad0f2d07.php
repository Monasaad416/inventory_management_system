												...
												<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('suppliers-invoice-item.edit', $product->pivot->id )); ?>" title="<?php echo e($product->pivot->id); ?>" >
                                                                <i class="fa fa-edit text-info mx-1" ></i>تعديل كمية البند
                                                            </a>
                                                            <a class="dropdown-item" href="<?php echo e(route('suppliers-invoices-item.return.view',['item_id'=> $product->pivot->id])); ?>">
                                                                <i class="fa fa-trash text-secondary mx-1"></i>تحويل كل الكمية إلي مرتجع
                                                            </a>

                                                            <a class="dropdown-item" href="<?php echo e(route('suppliers-invoices-item.return.part.view',['item_id'=> $product->pivot->id])); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/suppliers-invoices/show.blade.php ENDPATH**/ ?>