                        ...
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                ...
                                <p class="invoice-info-row"><span>رقم الفاتورة</span>
                                    <span><?php echo e($invoice->supplier_invoice_number); ?></span></p>
                                <p class="invoice-info-row"><span>تاريخ الفاتورة</span>
                                    <span><?php echo e($invoice->supplier_invoice_date); ?></span></p>
                        ...
                        <div class="container my-5">
                            <div class="row text-center">
                                ...
                                <div class="col-4 text-right">
                                    ...
                                    <h6>الاسم: <?php echo e($supplier->name); ?></h6>
                                    <p>العنوان: <?php echo e($supplier->address); ?><br>
                                        الهاتف: <?php echo e($supplier->phone); ?><br>
                                        البريدالإلكتروني: <?php echo e($supplier->email); ?></p>
                                </div>
                                <div class="col-md-1 text-right" >
                                    <div  style="height: 150px; width: 1px; background:rgb(217, 216, 216)"></div>
                                </div>
                                <div class="col-3 text-right">
                                    ...
                                    <h6>رقم الفاتوره <?php echo e($invoice->supplier_invoice_number); ?></h6>
                                    <p>تاريخ الفاتوره:<?php echo e($invoice->supplier_invoice_date); ?><br>
                                        اخر موعد للسداد: <?php echo e($invoice->due_date); ?><br>
                                        الحالة: <?php echo e($supplier->email); ?></p>
                                </div>
                            </div>
                            <hr>
                        </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/suppliers-invoices/print_invoice.blade.php ENDPATH**/ ?>