						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    ...
                                    <button class="btn btn-primary"><a class="x-small text-white" href="<?php echo e(route("shareholders_accounts.create")); ?>">إضافة معاملة</a></button>
										...
										<tbody>
                                            ...
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e($account->shareholder->name); ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('shareholders_accounts.edit',$account->id)); ?>" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="تعديل بيانات المصروف"><i class="fa fa-edit text-white" aria-hidden="true"></i></a>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_account<?php echo e($account->id); ?>" title="حذف المصروف"><i class="fa fa-trash"></i></button></td>
                                                                       <!-- Delete Modal -->
                                                        <form action="<?php echo e(route('shareholders_accounts.destroy',$account)); ?>" method="POST">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/shareholders_accounts/index.blade.php ENDPATH**/ ?>