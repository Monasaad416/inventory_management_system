                    ...
                    <div style="border-radius: 15px;" class="col-lg-10 col-md-10 bg-white">
                        ...
                        <div class="login-fancy pb-40 clearfix px-5">
                            ...
                            <div class="form-inline my-4">
                                <a class="btn btn-default col-lg-2" title="مساهم" href="<?php echo e(route('shareholder.login')); ?>">
                                    <h4>مساهم</h4>
                                </a>
                                <a class="btn btn-default col-lg-2" title="مؤسس" href="<?php echo e(route('founder.login')); ?>">
                                    <h4>مؤسس</h4>
                                </a>
                                <a class="btn btn-default col-lg-2" title="مورد" href="<?php echo e(route('supplier.login')); ?>">
                                    <h4>مورد</h4>
                                </a>
                                <a class="btn btn-default col-lg-2" title="عميل" href="<?php echo e(route('client.login')); ?>">
                                    <h4>عميل</h4>
                                </a>

                                <a class="btn btn-default col-lg-2" title="ادمن" href="<?php echo e(route('admin.login')); ?>">
                                    <h4>ادمن</h4>
                                </a>
                            </div>
...
<?php /**PATH C:\laragon\www\store\resources\views/auth/selection.blade.php ENDPATH**/ ?>