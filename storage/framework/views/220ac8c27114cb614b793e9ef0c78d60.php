        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('clients-invoices.store')); ?>" method="post" >
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row">
                            <div class="col my-2">
                                ...
                                <input type="number" class="form-control form-control-lg" id="discount" name="discount" step="any" value="<?php echo e(old('discount',0)); ?>" onchange="total()">
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col my-2">
                                ...
                                <input type="number" class="form-control form-control-lg" readonly id="totalAfterDiscount" name="total" step="any" value="<?php echo e(old('total')); ?>">
                            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/clients-invoices/create.blade.php ENDPATH**/ ?>