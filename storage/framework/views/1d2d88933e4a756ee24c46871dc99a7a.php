    ...
    <!-- table opened -->
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('clients.balance-sheet.search')); ?>" autocomplete="off">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/clients/show.blade.php ENDPATH**/ ?>