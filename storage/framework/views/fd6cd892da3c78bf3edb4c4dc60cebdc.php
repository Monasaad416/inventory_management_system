...
<?php $__env->startSection('page-header'); ?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">إضافة مؤسس</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المؤسسين</span>
            </div>
        </div>
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        ...
                        <form action="<?php echo e(route('founders.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\store\resources\views/pages/founders/create.blade.php ENDPATH**/ ?>