								...
								<div class="table-responsive">
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
                                            ...
                                            {{-- @php
                                                $pivotRow = DB::table('product_client_invoice')->where('product_id', '=', $product->id)->first();
                                            @endphp --}}
												...
												<tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('clients-invoice-item.edit', $product->pivot )}}" title="{{ $product->pivot->id }}" >
                                                                <i class="fa fa-edit text-info mx-1" ></i>تعديل كمية البند
                                                            </a>
                                                            {{-- <a class="dropdown-item" href="{{route('clients-invoice-item.unit.view', $product->pivot )}}" title="{{ $product->pivot->id }}" >
                                                                <i class="fa fa-edit text-info mx-1" ></i>تعيين وحدة البند
                                                            </a> --}}

                                                            <a class="dropdown-item" href="{{route('clients-invoices-item.return.view',['item_id'=> $product->pivot->id])}}">
                                                                <i class="fa fa-trash text-secondary mx-1"></i>تحويل كل الكمية إلي مرتجع
                                                            </a>

                                                            <a class="dropdown-item" href="{{route('clients-invoices-item.return.part.view',['item_id'=> $product->pivot->id])}}">
...
{{--
                                                        ...
                                                        <!-- Delete Modal -->
                                                        <form action="{{route('clients-invoices-item.return',$product->pivot )}}" method="POST">
