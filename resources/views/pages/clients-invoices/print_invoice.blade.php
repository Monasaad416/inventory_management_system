                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                ...
                                <p class="invoice-info-row"><span>رقم الفاتورة</span>
                                    <span>{{ $invoice->client_invoice_number }}</span></p>
                                <p class="invoice-info-row"><span>تاريخ الفاتورة</span>
                                    <span>{{ $invoice->client_invoice_date }}</span></p>
                        ...
                        {{-- <div class="invoice-header">
                            ...
                            <div class="billed-from">
                                ...
                                <h6>الاسم: {{ $client->name }}</h6>
                                <p>العنوان: {{ $client->address }}<br>
                                    الهاتف: {{ $client->phone }}<br>
                                   البريدالإلكتروني: {{ $client->email }}</p>
                            </div><!-- billed-from --> --}}
                        ...
                        <div class="container my-5">
                            <div class="row text-center">
                                ...
                                <div class="col-3 text-right">
                                    ...
                                    <h6>رقم الفاتوره {{ $invoice->client_invoice_number }}</h6>
                                    <p>تاريخ الفاتوره:{{ $invoice->client_invoice_date }}<br>
                                        اخر موعد للسداد: {{  $invoice->due_date }}<br>
                                        الحالة: {{ $client->email }}</p>
                                </div>
                            </div>
                            <hr>
                        </div>
                        ...
                        <div class="table-responsive mg-t-40" style="background-image: url('{{ url("assets/img/logo1.jpg")}}');">
