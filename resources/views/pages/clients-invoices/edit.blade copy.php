                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0 text-md-nowrap">
                                    ...
                                    <tbody class="products">
                                        @foreach ($invoice->section->products as $prod)
                                            @php
                                            ...
                                            @if(in_array($prod->id,$prodIds) )
                                                <tr>
                                                    ...
                                                    <td><input type="number" step="any" value="{{$prod->purchase_price}}" readonly class="form-control"></td>
                                            ...
                                            @if(count($prodIds) < $invoice->section->products->count() )

                                                <tr>
                                                    <td>
                                                        <input type="checkbox" class="checkbox" value="{{ $prod->id }}" name="product_ids[]" >
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="number" class="form-control qty" name="qty[]" min="0" step="any" value="0" disabled>
                                                    </td>

                                                    <td><input type="number" step="any" value="{{$prod->purchase_price}}" readonly class="form-control"></td>
                                                    <td><input type="number" step="any" value="0" name="sale_price[]" class="form-control price" readonly></td>
                                                    <td><input type="number" step="any" class="form-control product_total" value="0" readonly></td>
                                                    <td>
                                                        <select name="unit[]" class="form-control">
                                                            <option value="">إختار الوحدة</option>
