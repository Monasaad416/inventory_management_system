						...
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $suppliers->count() }}</h4>
										</div>
						...
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $clients->count() }}</h4>
										</div>
						...
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{ $sections->count() }}</h4>
										</div>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">{{$products->count()}}</h4>
										</div>
											...
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-0">
														...
														<p class="mb-0 tx-13 text-muted"> <span class="text-success ml-2">{{ $clientsInvoicesPaid }}</span></p>
													</div>
											...
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
														...
														<p class="mb-0 tx-13 text-muted"> <span class="text-danger ml-2">{{ $clientsInvoicesUnPaid }}</span></p>
													</div>
													<span class="mr-auto wd-45p fs-16 mt-2">
											...
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
														...
														<p class="mb-0 tx-13 text-muted"><span class="text-danger ml-2">{{ $clientsInvoicesPartPaid }}</span></p>
													</div>
													<span class="mr-auto wd-45p fs-16 mt-2">
											...
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
														...
														<p class="mb-0 tx-13 text-muted"><span class="text-success ml-2">{{ $clientsInvoicesRetutn }}</span></p>
													</div>
													<span class="mr-auto wd-45p fs-16 mt-2">
											...
											<div class="media-body">
												<div class="d-flex align-items-center">
													<div class="mt-1">
														...
														<p class="b-0 tx-13 text-muted mb-0"><span class="text-success ml-2">{{ $clientsInvoicesPartRetutn }}</span></p>
													</div>
													<span class="mr-auto wd-45p fs-16 mt-2">
