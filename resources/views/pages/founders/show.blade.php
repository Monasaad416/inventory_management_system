...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">كشف حساب المؤسس</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة العملاء</span>
    ...
    <!-- table opened -->
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('founders.balance-sheet.search') }}" autocomplete="off">
                        @csrf
                    ...
                    <div class="table-responsive my-5">
                        <h3>البيانات الأساسية المؤسس</h3>
                        <table id="example1" class="table key-buttons text-md-nowrap">
                            <thead>
                                <tr>
                                    <th class="border-bottom-0">اسم المؤسس</th> </th>
