    ...
    <!-- table opened -->
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="d-flex">
                @if($from && $to)
                    <h5 class="content-title mb-0 my-auto">كشف حساب المورد عن الفترة من <span class="text-danger">{{$from }}</span> الي  <span class="text-danger">  {{$to }}</span></h5><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
                @else
