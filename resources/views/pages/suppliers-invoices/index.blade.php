					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<div class=" d-inline-flex justify-content-around mt-5">
								<div><button class="btn btn-primary"><a class="custom_link text-white" href="{{route('suppliers-invoices.create')}}">إضافة فاتورة</a></button></div>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example1" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											@foreach($suppliersInvoices as $invoice)
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                              <a class="dropdown-item"  href="{{route('suppliers-invoices.edit',$invoice)}}">
                                                                <i class="fa fa-edit text-info mx-1"></i>تعديل الفاتورة
                                                              </a>

                                                            <a class="dropdown-item"  href="{{route('suppliers-invoices.show',$invoice)}}">
                                                            ...
                                                            <a class="dropdown-item" href="{{route('print-invoice',['invoice_id'=>$invoice->id])}}"><i class="fa fa-print mx-1" aria-hidden="true"></i>طباعة الفاتورة</a>
                                                          </div>
                                                    </td>
												</tr>
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="{{route('suppliers-invoice.return',$invoice->id)}}">
                                                                                                    @csrf
                                                                                                     {{-- {{ method_field('delete') }} --}}
                                                                                                    <p class="text-danger font-weight-bold my-3">هل انت متأكد من حذف الفاتورة رقم  {{$invoice->supplier_invoice_number}}</p>
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                        <div class="col-lg-12">
                                                                                            <div class="bg-gray-200 p-4">
                                                                                                <form method ="POST" action="{{route('suppliers-invoice.partially-paid',$invoice->id)}}">
                                                                                                    @csrf
                                                                                                     {{-- {{ method_field('delete') }} --}}
                                                                                                    <p class=" font-weight-bold my-3">ادخل المبلغ الذي تم سداده  من الفاتورة رقم  {{$invoice->supplier_invoice_number}}</p>
                                                                                                    <input class="form-control" name="invoice_id" value="{{$invoice->id}}" type="hidden">
