...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">تعديل فاتورة رقم {{$invoice->supplier_invoice_number}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ فواتير الموردين </span>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    {{-- @include('inc.errors') --}}
                    <form action="{{ route('suppliers-invoices.update' ,$invoice) }}" method="post">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_date" placeholder="YYYY-MM-DD" type="text" value="{{ old('supplier_invoice_date', $invoice->supplier_invoice_date) }}">
                            </div>
                            @error('invoice_date')
                            ...
                            <div class="col my-2">
                                ...
                                <select name="supplier_id" class="form-control">
                                    @foreach ($suppliers as $supplier)
                                     @if( $supplier->id == $invoice->user_id )
                                                     ...
                                                     @php
                                                       ...
                                                       @endphp
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="number" class="form-control qty" data-quantity="{{$pivotRow->qty}}"  name="qty[]" min="0" step="any" value="{{$pivotRow->qty}}">
                                                            </td>


                                                            <td><input type="number" step="any" value="{{$prod->purchase_price}}" name="purchase_price[]" class="form-control price" ></td>
                                                        ...
                                                        {{-- <div class="row">
                                                            <div class="col-3">
                                                                <input type="checkbox" checked name="product_ids[]" value="{{ $prod->id }}"> {{ $prod->product_name }}
                                                            </div>
                                                            <div class="col-9">الكميه : <input type="number" class="form-control" name="qty[]" min="0" step="any" value={{ $pivotRow->qty }}></div>
                                                        </div> --}}
