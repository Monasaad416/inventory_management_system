						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    ...
                                    <button class="btn btn-primary"><a class="x-small text-white" href="{{route("founders_accounts.create")}}">إضافة معاملة</a></button>
										...
										<tbody>
                                            ...
                                            @foreach ($accounts as $account )
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('founders_accounts.edit',$account->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="تعديل بيانات المصروف"><i class="fa fa-edit text-white" aria-hidden="true"></i></a>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_account{{ $account->id }}" title="حذف المصروف"><i class="fa fa-trash"></i></button></td>
                                                                       <!-- Delete Modal -->
                                                        <form action="{{route('founders_accounts.destroy',$account)}}" method="POST">
